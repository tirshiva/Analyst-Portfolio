...
import { FaBars, FaTimes, FaBrain, FaRobot, FaUserTie, FaEnvelope, FaChartBar, FaArrowUp, FaGraduationCap, FaBriefcase } from 'react-icons/fa';
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Experience', href: 'experience', icon: <FaBriefcase className="w-4 h-4" /> },
